...
Fonts are baked into the image at lms/static/certificates/fonts/ (no images there).
"""
import io
import json
import math
...
def generate_preview_bytes(tuning: dict, student_name: str = "Sample Student",
                           cert_display_id: str = "LMS-2026-DEMO1",
                           verify_url: str = "https://yourdomain.example.com/certificate/preview") -> bytes:
